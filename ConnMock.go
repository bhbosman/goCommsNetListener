...
// Source: net (interfaces: Conn,Addr,Listener)
...
// argString:
// rets: [net.Conn error]
// retString: net.Conn, error
// retString:  (net.Conn, error)
// ia: map[]
// idRecv: mr
// 0
func (mr *MockListenerMockRecorder) OnAcceptDoAndReturn(
	f func() (net.Conn, error)) *gomock.Call {
	return mr.
		Accept().
		DoAndReturn(f)
}
...
// 0
func (mr *MockListenerMockRecorder) OnAcceptDo(
	f func()) *gomock.Call {
	return mr.
		Accept().
		DoAndReturn(f)
...
// retNames: [ret0 ret1]
// retArgs: [ret0 net.Conn ret1 error]
// retArgs22: ret0 net.Conn,ret1 error
// 1
func (mr *MockListenerMockRecorder) OnAcceptReturn(ret0 net.Conn, ret1 error) *gomock.Call {
	return mr.
		Accept().
		Return(ret0, ret1)
}
...
// idRecv: mr
// 0
func (mr *MockListenerMockRecorder) OnAddrDoAndReturn(
	f func() net.Addr) *gomock.Call {
	return mr.
		Addr().
		DoAndReturn(f)
...
// 0
func (mr *MockListenerMockRecorder) OnAddrDo(
	f func()) *gomock.Call {
	return mr.
		Addr().
		DoAndReturn(f)
...
// retArgs22: ret0 net.Addr
// 1
func (mr *MockListenerMockRecorder) OnAddrReturn(ret0 net.Addr) *gomock.Call {
	return mr.
		Addr().
		Return(ret0)
}
...
// idRecv: mr
// 0
func (mr *MockListenerMockRecorder) OnCloseDoAndReturn(
	f func() error) *gomock.Call {
	return mr.
		Close().
		DoAndReturn(f)
...
// 0
func (mr *MockListenerMockRecorder) OnCloseDo(
	f func()) *gomock.Call {
	return mr.
		Close().
		DoAndReturn(f)
...
// retArgs22: ret0 error
// 1
func (mr *MockListenerMockRecorder) OnCloseReturn(ret0 error) *gomock.Call {
	return mr.
		Close().
		Return(ret0)
}
